...
import com.RM.POM.Change_Seat_Obj;
...
public class Change_Seat_Test {
	...
	public void Change_seat(WebDriver driver, String Request_id,String First, String Personnel_Number,String comments,ExtentTest logger) throws Exception
	{
		try
		{
				...
				// Click on WP button
					...
					WP_button.click();
					gm.logInfo(logger, "We have clicked on WP radio button");
					Thread.sleep(3000);
					...
					WebElement save_btn = driver.findElement(Change_Seat_Obj.save_btn);
					save_btn.click();
					Thread.sleep(2000);
					...
					WebElement WP_button1 = driver.findElement(OB_NewHire_Obj.completed_WP);
					WP_button1.click();
					gm.logPass(logger, "We have clicked on WP radio button", driver);
					Thread.sleep(5000);
					...
					{
						gm.logPass(logger, "The request id" + Request_id + "for WP Change seat is completed", driver);
					}
					else
					{
	...
	public void Change_seat_Multiple(WebDriver driver, String Request_id,String First,String Personnel_Number,String comments,ExtentTest logger) throws Exception
	{
		try
		{
					...
					public void MultipleComplete(WebDriver driver, String Request_id,String First,String Personnel_Number,String comments,ExtentTest logger) throws Exception
	{
		try
		{
			cm.Complete_count();
					...
					//click on WP radio button
					WebElement WP_button = driver.findElement(OB_NewHire_Obj.completed_WP);
					WP_button.click();
					gm.logPass(logger, "We have clicked on WP radio button", driver);
					Thread.sleep(3000);
